        ...
        <div class="container">
            <div class="row">
                <div class="content-homepage col-md-10 content-full nice-copy-story">
                    <h1>
                        Terms of service of Smalljobsnaija(gigsclan).
                    </h1>
                    

<h3> SmalljobsNaija (gigsclan) builds technologies and services that enable people showcase, connect and find talents nearby. These Terms govern your use of SmallJobsNaija and the other products, features, apps, services, technologies and software that we offer, except where we expressly state that separate terms (and not these) apply. These Products are provided to you by Noma Integrated Technology Solutions.

    We don't charge you to use or the other products and services covered by these Terms. Instead, businesses and organisations pay us to show you ads for their products and services. By using our Products, you agree that we can show you ads that we think will be relevant to you and your interests. We use your personal data to help determine which ads to show you.
    ...
    Your experience on SmalljobsNaija(gigsclan) is unlike anyone else's: from the posts, stories, events, ads and other content that you see in News Feed or our video platform to the Pages that you follow and other features that you might use, such as Trending, Marketplace and search. 
    <br>
...
Provide consistent and seamless experiences across the SmalljobsNaija(gigsclan) </h3>
<br>
...
Our Products help you find and connect with people, groups, businesses, organisations and others that are important to you.
Enable global access to our services:
To operate our global service, we need to store and distribute content and data in our data centres and systems around the world, 
including outside your country of residence. 
This infrastructure may be operated or controlled by Noma Integrated Technology Solutions or its affiliates. </h4>
</h3>

<h2> How our services are funded </h2>
<h3>
Instead of paying to use SmalljobsNaija(gigsclan) and the other products and services we offer, by using the SmalljobsNaija(gigsclan) Products covered by these Terms, you agree that we can show you ads that businesses and organisations pay us to promote on and off the SmalljobsNaija(gigsclan) Company Products. We use your personal data, such as information about your activity and interests, to show you ads that are more relevant to you.
...
<h4>
<h2> Your commitments to SmalljobsNaija(gigsclan) and our community </h2>
<h3>
...
<br> <h2>  1. Who can use SmalljobsNaija(gigsclan)</h2>
<ul>
   <li>When people stand behind their opinions and actions, our community is safer and more accountable. For this reason, you must:</li> 
    ...
    <li>not share your password, give access to your SmalljobsNaija(gigsclan) account to others or transfer your account to anyone else (without our permission).</li> 
</ul>
<br>

We try to make SmalljobsNaija(gigsclan) broadly available to everyone, but you cannot use SmalljobsNaija(gigsclan) if:
<br>
<ul>
...
<br>
<h2>
    2. What you can share and do on SmalljobsNaija(gigsclan)
</h2>
<br>
We want people to use SmalljobsNaija(gigsclan) to express themselves and to share content that is important to them, but not at the expense of the safety and well-being of others or the integrity of our community. You therefore agree not to engage in the conduct described below (or to facilitate or support others in doing so):
<br>
1.	You may not use our Products to do or share anything:
<li>That breaches these Terms, our Community Standards, and other Terms and Policies that apply to your use of SmalljobsNaija(gigsclan).</li>	
...
You own the intellectual property rights (things such as copyright or trademarks) in any such content that you create and share on SmalljobsNaija(gigsclan) and the other SmalljobsNaija(gigsclan) Company Products you use. Nothing in these Terms takes away the rights you have to your own content. You are free to share your content with anyone else, wherever you want.
...
Specifically, when you share, post or upload content that is covered by intellectual property rights on or in connection with our Products, you grant us a non-exclusive, transferable, sub-licensable, royalty-free and worldwide licence to host, use, distribute, modify, run, copy, publicly perform or display, translate and create derivative works of your content. This means, for example, that if you share a photo on SmalljobsNaija(gigsclan), you give us permission to store, copy and share it with others (again, consistent with your settings) such as service providers that support our service or other SmalljobsNaija(gigsclan) Products you use.This licence will end when your content is deleted from our systems.
2.	Permission to use your name, profile picture and information about your actions with ads and sponsored content: You give us permission to use your name and profile picture and information about actions that you have taken on SmalljobsNaija(gigsclan) next to or in connection with ads, offers and other sponsored content that we display across our Products, without any compensation to you. For example, we may show your friends that you are interested in an advertised event or have liked a Page created by a brand that has paid us to display its ads on SmalljobsNaija(gigsclan). Ads like this can be seen only by people who have your permission to see the actions that you've taken on SmalljobsNaija(gigsclan
...
If you use content covered by intellectual property rights that we have and make available in our Products (for example, images, designs, videos or sounds that we provide, which you add to content that you create or share on SmalljobsNaija(gigsclan)), we retain all rights to that content (but not yours). You can only use our copyrights or trademarks (or any similar marks) as expressly permitted by our Brand Usage Guidelines or with our prior written permission. You must obtain our written permission (or permission under an open source licence) to modify, create derivative works of, decompile or otherwise attempt to extract source code from us.
...
We hope that you will continue using our Products, but if you do not agree to our updated Terms and no longer want to be part of the SmalljobsNaija(gigsclan) community, you can delete your account at any time.
<br>
<h3>
    2. Account suspension or termination
</h3>
<br>
We want SmalljobsNaija(gigsclan) to be a place where people feel welcome and safe to express themselves and share their thoughts and ideas.
...
<br>
<ul>
    <li>1.	These Terms (formerly known as the Statement of Rights and Responsibilities) make up the entire agreement between you and SmalljobsNaija(gigsclan), Inc. regarding your use of our Products. They supersede any prior agreements.</li>
    <li>2.	If any portion of these Terms is found to be unenforceable, the remaining portion will remain in full force and effect. If we fail to enforce any of these Terms, it will not be considered a waiver. Any amendment to or waiver of these Terms must be made in writing and signed by us.</li>
    <li>3.	You will not transfer any of your rights or obligations under these Terms to anyone else without our consent.</li>
    <li>4.	You may designate a person (called a legacy contact) to manage your account if it is memorialised. Only your legacy contact or a person who you have identified in a valid will or similar document expressing clear consent to disclose your content upon death or incapacity will be able to seek disclosure from your account after it is memorialised.</li>
    <li>5.	These Terms do not confer any third-party beneficiary rights. All of our rights and obligations under these Terms are freely assignable by us in connection with a merger, acquisition or sale of assets, or by operation of law or otherwise.</li>
    <li>6.	You should know that we may need to change the username for your account in certain circumstances (for example, if someone else claims the username and it appears unrelated to the name that you use in everyday life). We will inform you in advance if we have to do this and explain why.</li>
    <li>7.	We always appreciate your feedback and other suggestions about our products and services. But you should know that we may use them without any restriction or obligation to compensate you, and we are under no obligation to keep them confidential.</li>
    <li>8.	We reserve all rights not expressly granted to you.</li>
